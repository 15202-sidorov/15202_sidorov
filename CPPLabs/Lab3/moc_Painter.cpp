...
static const char qt_meta_stringdata_PainterWindow[] = {
    "PainterWindow\0\0addCoord()\0"
};
...
const QMetaObjectExtraData PainterWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PainterWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PainterWindow,
      qt_meta_data_PainterWindow, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PainterWindow::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PainterWindow))
